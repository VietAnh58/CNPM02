  ...
  <body>
    ...
    <section class="health_section layout_padding">
      <div class="health_carousel-container">
        ...
        <div class="carousel-wrap layout_padding2">
          ...
          <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1028px, 0px, 0px); transition: all 0.25s ease 0s; width: 2742px;"><div class="owl-item cloned" style="width: 332.675px; margin-right: 10px;"><div class="item">
              <div class="box">
            ...
            </div></div><div class="owl-item cloned" style="width: 332.675px; margin-right: 10px;"><div class="item">
              <div class="box">
                <div class="btn_container">
                  <a href="">
                    Buy Now
            ...
            </div></div><div class="owl-item" style="width: 332.675px; margin-right: 10px;"><div class="item">
              <div class="box">
                <div class="btn_container">
                  <a href="">
                    Buy Now
            ...
            </div></div><div class="owl-item active" style="width: 332.675px; margin-right: 10px;"><div class="item">
              <div class="box">
                <div class="btn_container">
                  <a href="">
                    Buy Now
    ...
    <section class="about_section layout_padding">
      <div class="container">
        ...
        <div class="img-box">
          <img src="{{asset('assets/images/about-medicine.png')}}" alt="">
        </div>
        <div class="detail-box">
          <p>
            ...
            <div class="carousel-item">
              <div class="client_container layout_padding2">
                ...
                <div class="client_box ">
                  <div class="img-box">
                    <img src="{{asset('assets/images/about-client.png')}}" alt="">
                  </div>
                  <div class="name">
                    <h5>
                      Randomised
