...
<body>
      ...
      <div class="container">
        ...
        <div class="top_contact-container">
          <div class="tel_container">
            <a href="">
              <img src="{{asset('assets/images/telephone-symbol-button.png')}}" alt=""> Call : +01 1234567890
            </a>
          </div>
        ...
        <div class="box">
          <div class="img-box">
            <svg id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
              <path d="m471.728 84.718h-431.456c-22.206 0-40.272 18.066-40.272 40.272v243.623 18.395.005c0 22.205 18.064 40.27 40.27 40.27h431.46c22.205 0 40.27-18.065 40.27-40.27v-.005-18.395-243.623c0-22.206-18.066-40.272-40.272-40.272zm-431.456 20h431.455c11.179 0 20.272 9.094 20.272 20.272v233.623h-294.622c-5.522 0-10 4.477-10 10s4.478 10 10 10h294.623v8.395c0 11.178-9.094 20.272-20.272 20.272h-431.456c-11.178 0-20.272-9.094-20.272-20.273v-8.395h89.418c5.522 0 10-4.477 10-10s-4.478-10-10-10h-89.418v-233.622c0-11.178 9.094-20.272 20.272-20.272z"></path>
              <path d="m280.063 167.544h53.989c5.522 0 10-4.477 10-10s-4.478-10-10-10h-53.989c-5.522 0-10 4.477-10 10s4.477 10 10 10z"></path>
              <path d="m377.55 167.544h55.505c5.522 0 10-4.477 10-10s-4.478-10-10-10h-55.505c-5.522 0-10 4.477-10 10s4.477 10 10 10z"></path>
              <path d="m280.063 210.314h152.992c5.522 0 10-4.477 10-10s-4.478-10-10-10h-152.992c-5.522 0-10 4.477-10 10s4.477 10 10 10z"></path>
              <path d="m280.063 254.169h45.989c5.522 0 10-4.477 10-10s-4.478-10-10-10h-45.989c-5.522 0-10 4.477-10 10s4.477 10 10 10z"></path>
              <path d="m422.75 234.169h-38.993c-13.348 0-24.207 10.859-24.207 24.207v37.636c0 13.348 10.859 24.208 24.207 24.208h38.993c13.348 0 24.207-10.859 24.207-24.208v-37.636c0-13.348-10.859-24.207-24.207-24.207zm4.207 61.843c0 2.32-1.888 4.208-4.207 4.208h-38.993c-2.319 0-4.207-1.888-4.207-4.208v-37.636c0-2.32 1.888-4.207 4.207-4.207h38.993c2.319 0 4.207 1.887 4.207 4.207z"></path>
              <path d="m280.063 298.297h45.989c5.522 0 10-4.477 10-10s-4.478-10-10-10h-45.989c-5.522 0-10 4.477-10 10s4.477 10 10 10z"></path>
              <path d="m79.072 319.081h140.993c5.522 0 10-4.477 10-10v-39.955-114.582c0-5.523-4.478-10-10-10h-140.993c-5.522 0-10 4.477-10 10v114.583 39.955c0 5.522 4.478 9.999 10 9.999zm130.993-20h-120.993v-28.724c.03-.113.06-.227.091-.339 4.169-15.41 18.521-26.172 34.902-26.172h51.008c16.38 0 30.732 10.763 34.902 26.169.03.113.061.226.09.339zm-81.794-96.534c0-11.744 9.554-21.298 21.298-21.298s21.298 9.554 21.298 21.298-9.554 21.298-21.298 21.298-21.298-9.554-21.298-21.298zm81.794 33.371c-7.335-5.755-16.118-9.714-25.618-11.298 4.058-6.39 6.42-13.958 6.42-22.073 0-17.041-10.376-31.702-25.14-38.003h44.339v71.374zm-76.653-71.374c-14.765 6.301-25.14 20.963-25.14 38.003 0 8.114 2.362 15.683 6.42 22.073-9.501 1.583-18.285 5.543-25.619 11.298v-71.374z"></path>
              <path d="m159.66 360.3c-7.549-5.03-17.605 2.261-15.18 10.977 1.142 4.104 4.876 7.118 9.141 7.321 4.271.204 8.264-2.408 9.808-6.389 1.66-4.282.096-9.38-3.769-11.909z"></path>
            </svg>
          </div>
          <div class="detail-box">
            <h5>
            ...
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 315.377 315.377" style="enable-background:new 0 0 315.377 315.377;" xml:space="preserve">
              <g>
                <g>
                 ...
                 c4.289-2.995,8.704-4.515,13.127-4.515c8.608,0,12.971,4.28,12.971,12.662C137.142,152.524,127.72,162.721,107.712,181.769z"></path>
                </g>
                <g>
                 ...
                 c4.434-6.438,12.015-17.487,17.453-25.653V165.045z"></path>
                </g>
                <g>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-5">
          <div class="img-box">
            <img src="{{asset('assets/images/medicines.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="health_section layout_padding">
    <div class="health_carousel-container">
      ...
      <div class="carousel-wrap layout_padding2">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2410px, 0px, 0px); transition: all 0.25s ease 0s; width: 4132px;"><div class="owl-item cloned" style="width: 334.32px; margin-right: 10px;"><div class="item">
            <div class="box">
            ...
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{asset('assets/images/p-5.jpg')}}" alt="">
              </div>
              <div class="detail-box">
                <div class="star_container">
                  <i class="fa fa-star" aria-hidden="true"></i>
          ...
          </div></div><div class="owl-item cloned" style="width: 334.32px; margin-right: 10px;"><div class="item">
            <div class="box">
              <div class="btn_container">
                <a href="">
                  Buy Now
          ...
          </div></div><div class="owl-item" style="width: 334.32px; margin-right: 10px;"><div class="item">
            <div class="box">
              <div class="btn_container">
                <a href="">
                  Buy Now
          ...
          </div></div><div class="owl-item active" style="width: 334.32px; margin-right: 10px;"><div class="item">
            <div class="box">
              <div class="btn_container">
                <a href="">
                  Buy Now
          ...
          </div></div><div class="owl-item cloned active" style="width: 334.32px; margin-right: 10px;"><div class="item">
            <div class="box">
              <div class="btn_container">
                <a href="">
                  Buy Now
          ...
          </div></div></div></div><div class="owl-nav disabled"><div class="owl-prev"></div><div class="owl-next"></div></div><div class="owl-dots disabled"><div class="owl-dot active"><span></span></div></div></div>
      </div>
    </div>
    <div class="health_carousel-container">
      <h2 class="text-uppercase">
      ...
      <div class="carousel-wrap layout_padding2">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2410px, 0px, 0px); transition: all 0.25s ease 0s; width: 4132px;"><div class="owl-item cloned" style="width: 334.32px; margin-right: 10px;"><div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{asset('assets/images/p-6.jpg')}}" alt="">
              </div>
              <div class="detail-box">
                <div class="star_container">
                  <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <section class="client_section layout_padding">
    <div class="container">
      ...
      <div id="carouselExample2Indicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
          <li data-target="#carouselExample2Indicators" data-slide-to="0" class=""></li>
          <li data-target="#carouselExample2Indicators" data-slide-to="1" class=""></li>
          <li data-target="#carouselExample2Indicators" data-slide-to="2" class="active"></li>
        </ol>
        <div class="carousel-inner">
          <div class="carousel-item">
            <div class="client_container layout_padding2">
              ...
              <div class="client_box ">
                <div class="img-box">
                  <img src="{{asset('assets/images/fb\\images/client.png')}} " alt="">
                </div>
                <div class="name">
                  <h5>
                    Randomised
                  ...
                  <h6>
                    ...
                    <img src="{{asset('assets/images/fb\\images/quote.png')}}" alt="">
                  </h6>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_contact">
            ...
            <div class="box">
              <div class="img-box">
                <img src="{{asset('assets/images/telephone-symbol-button.png')}}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  +01 123567894
  ...
  <script type="text/javascript" src="{{asset('assets/jquery-3.4.1.min.js')}}"></script>
